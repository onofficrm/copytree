    ...
    <footer className="bg-[#0F141F] text-slate-400 text-sm border-t border-[#1F293D]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-bold text-lg">창원개인회생 지원센터</span>
            </div>
            <p className="text-xs text-slate-400 leading-relaxed max-w-md">
              과중한 채무로 감당하기 힘든 나날을 보내고 계신 분들에게 따뜻한 법률 솔루션을 제공합니다.
              더 이상 혼자 짊어지지 마시고 국가가 보장하는 합법적인 개인회생·파산 제도로 새 삶을 시작하세요.
            </p>
            <div className="flex items-center gap-4 pt-2">
              ...
              >
                ...
                <span>무료 전화상담 1800-0000</span>
              </a>
              <button
                onClick={onOpenQuickCounsel}
                className="inline-flex items-center gap-1.5 bg-[#D7AE66] text-[#151C2C] px-4 py-2.5 rounded-xl font-bold text-sm hover:bg-[#c59c53] transition-colors"
              >
                <span>온라인 간편상담</span>
              </button>
            </div>
        ...
        <div className="pt-8 border-t border-[#1C2538] text-[11px] text-slate-400 space-y-2 leading-relaxed">
          <p>
            상호: 창원개인회생 법률지원센터 | 대표변호사: 김도산 | 등록번호: 제2024-XXXX호 | 사업자등록번호: 123-45-67890
          </p>
          <p>
            주소: 경상남도 창원시 성산구 창이대로 (창원지방법원 사파동 법조타운 앞) | 대표전화: 1800-0000 | 팩스: 055-000-0000 | 이메일: contact@changwon-rehab.kr
          </p>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-4 text-slate-400 border-t border-[#182030] mt-4">
            <div>© 2026 창원개인회생 지원센터. All rights reserved. (Designed for GnuBoard & Cursor Development)</div>
            <div className="flex items-center gap-3">
