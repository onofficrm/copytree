...
<div id="top-notice-bar" class="bg-[#111723] text-slate-300 text-xs py-1.5 px-4 border-b border-[#1E283C]">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="tel:1800-0000" class="text-[#D7AE66] font-bold">1800-0000</a>
        </div>
    </div>
</div>
...
<header id="header" class="sticky top-0 z-40 bg-[#151C2C] text-white border-b border-[#222E46] shadow-md h-[68px]">
    <div class="max-w-7xl mx-auto h-full px-4 sm:px-6 flex items-center justify-between">
        ...
        <a href="<?php echo G5_URL; ?>" class="flex items-center gap-2.5 group">
            ...
            <div>
                <div class="flex items-center gap-1.5">
                    <span class="text-lg sm:text-xl font-black text-white group-hover:text-[#D7AE66]">창원개인회생</span>
                    <span class="text-[10px] bg-[#252f44] text-[#D7AE66] px-1.5 py-0.5 rounded border border-[#D7AE66]/30 font-semibold">안심지원센터</span>
                </div>
                <p class="text-[11px] text-slate-400 font-normal">창원·경남 관할 창원지방법원 전문 안심상담</p>
            </div>
        </a>
        ...
        <div class="hidden lg:flex items-center gap-3">
            <a href="tel:1800-0000" class="flex items-center gap-2 px-3 py-2 rounded-xl text-slate-200 hover:text-[#D7AE66]">
                ...
                <div class="leading-tight">
                    ...
                    <div class="text-sm font-bold text-white">1800-0000</div>
                </div>
            </a>
        ...
        <div class="flex items-center gap-2 lg:hidden">
            <a href="tel:1800-0000" class="p-2 text-[#D7AE66] bg-[#222E46] rounded-lg"><i class="fa fa-phone"></i></a>
...
// send_aligo_sms($phone, "창원개인회생 비공개 상담신청 접수완료");
