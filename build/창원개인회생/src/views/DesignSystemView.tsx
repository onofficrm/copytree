...
export const DesignSystemView: React.FC<DesignSystemViewProps> = ({ onNavigate }) => {
  ...
  const uxChecklist = [
    ...
    },
    {
      ...
      a: '예. 모바일 하단 58px 슬림 고정바에 [전화상담 1800-0000], [1분 자가진단], [상담 신청하기]가 항상 엄지손가락 영역에 유지되어 전환이 즉시 발생합니다.',
    },
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border border-gray-200 rounded-2xl p-5 bg-gray-50 space-y-3">
            ...
            <ul className="text-xs text-gray-600 space-y-1.5 list-disc pl-4">
              ...
              <li><strong>Bottom CTA</strong>: [전화상담 1800-0000] [자가진단] [상담신청] 3-Way 고정</li>
            </ul>
          </div>
        </div>
      </section>
