...
import counselingHero from '../../assets/images/counseling_hero_1789524227384.jpg';
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="space-y-2">
              <h1 className="text-3xl sm:text-4xl lg:text-[44px] font-extrabold text-white tracking-tight leading-[1.25]">
                혼자 고민하지 마세요.<br />
                <span className="text-[#D7AE66]">창원개인회생·파산</span>, 지금부터 차근차근 알아보세요.
              </h1>
              {/* Secondary text */}
              <p className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-xl pt-2 font-normal">
                현재 상황에 맞는 개인회생 월 변제금 탕감률 및 파산 면책 가능성을 비공개 법률상담을 통해 확인해보세요.
                과도한 채무로 인한 불안감을 내려놓으실 수 있도록, 창원지방법원(창원·경남 관할) 합법적인 채무조정 절차를 체계적으로 안내해 드립니다.
              </p>
            </div>
